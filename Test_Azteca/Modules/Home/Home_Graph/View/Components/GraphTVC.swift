...
class GraphTVC: UITableViewCell {
    ...
    var colorsChartView : [NSUIColor] = [
        NSUIColor(red: 77, green: 180, blue: 175, alpha: 1.0),
        NSUIColor(red: 255, green: 70, blue: 90, alpha: 1.0),
        NSUIColor(red: 255, green: 144, blue: 0, alpha: 1.0),
        NSUIColor(red: 125, green: 133, blue: 0, alpha: 1.0),
        NSUIColor(red: 248, green: 220, blue: 0, alpha: 1.0),
        NSUIColor(red: 10, green: 200, blue: 245, alpha: 1.0),
    ]
